...
export const UploadAvatar = ({
    handleImageSelect, imagePreview, uploadProgress, isLoading,variant= "primary"
}: Props) => {
    ...
    return (
        <div className="flex items-center gap-5">
            ...
            <label className={clsx(
                ...
                variant === "outline" && "bg-white hover:bg-gray-400/50 boeder border-gray-500",
                "inline-block  rounded px-[18px] py-[15px] text-caption2 font-meduim  animate"
            )}>
            ...
            <Avatar size="extra-large" alt="Avatar"
            isLoading={isLoading}
                src={
                    imagePreview ?
